import Vedioss from '../../../videos/hero.mp4'
import HeaderLinks from '@components/HeaderLinks/HeaderLinks'
const Video = () => {
    return (
        <>
            <div className="main_hero full_page primary_bg f a-c">
                <div className="hero_cover full_bg">
                    <i className="full_bg">
                        <video
                            loop
                            muted
                            ...
                            playsInline={true}
                        >
                            <source src={Vedioss} type="video/mp4" />
                        </video>
                    </i>
                </div>
                ...
                {/* <div className="">
                    <>
                        <a
                            ...
                            href={socialmedialinks[0]?.linkedin}
                            target="_blank"
                            data-dist="1"
                        >
                            <svg
                        ...
                        <a
                            className="f a-c j-c magnet"
                            href={socialmedialinks[0]?.instagram}
                            target="_blank"
                            data-dist="1"
                        >
                            <svg
                        ...
                        <a
                            className="f a-c j-c magnet"
                            href={socialmedialinks[0]?.twitter}
                            target="_blank"
                            data-dist="1"
                        >
                            <svg
                        ...
                        <a
                            className="f a-c j-c magnet"
                            href={socialmedialinks[0]?.facebook}
                            target="_blank"
                            data-dist="1"
                        >
                            <svg
            ...
            <div className="social f f-c custom-hero-icon">
                <a
                    className="f a-c j-c magnet"
                    href="https://sa.linkedin.com/company/third-milling-company"
                    target="_blank"
                    data-dist="1"
                >
                    <svg
                ...
                <a
                    className="f a-c j-c magnet"
                    href="https://www.instagram.com/modernmillscorp/"
                    target="_blank"
                    data-dist="1"
                >
                    <svg
                ...
                <a
                    className="f a-c j-c magnet"
                    href="https://twitter.com/modernmillscomp"
                    target="_blank"
                    data-dist="1"
                >
                    <svg
                ...
                <a
                    className="f a-c j-c magnet"
                    href="https://www.facebook.com/Modernmillscorporate/"
                    target="_blank"
                    data-dist="1"
                >
                    <svg
