...
import ModernMills from '../ModernMills/ModernMills'
            ...
            <div className="inner_padding light_bg f f-c x_padding">
                <div className="section_wrap f f-c">
                    <div className="bc f a-c">
                        ...
                        <Link to="/qoot-and-root" className="_underline _eleX">
                            {t('qootandrootlabel')}
                        </Link>
                    </div>
                        ...
                        <div className="head_side f a-c">
                            <div className="dropdown_set f a-c">
                                <select className="menu transit-all" id="brand">
                                    ...
                                    <option value="modern-mills">
                                        {t('modernmillslabel')}
                                    </option>
                                    <option value="qoot-and-root" selected>
                                        {t('qootandrootlabel')}
                                    </option>
                                </select>
                                <svg
